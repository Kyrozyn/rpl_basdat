    ...
    <div class="col-sm-10 text-left">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><?php echo $waktu_awal." <b> sampai </b> ".$waktu_akhir; ?></td>
            </tr>
            <tr>
            	<th>Waktu Kesepakatan</th>
            	<td><?php echo $waktu_kesepakatan; ?></td>
            </tr>
            <tr>
        ...
        <!-- <form action="" method="post">
            <div class="form-group">
                <label for="id_alatmusik">Kode Sewa:</label>
                <input type="text" class="form-control" name="" value="<?php echo $kode_sewa;?>" readonly >
            </div>
            <div class="form-group">
                <label for="id_alatmusik">Kode Sewa:</label>
                <input type="text" class="form-control" name="" value="<?php echo $namapel;?>" readonly >
            </div>
